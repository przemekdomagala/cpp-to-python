...
for_loop: FOR LEFT_PARENTHESIS non_const_variable SEMICOLON LOG_NOT? ID (LESSER | LESSER_EQUAL | GREATER | GREATER_EQUAL | EQUAL | NONEQUAL) (ID | ANY_LITERAL) ((LOG_AND | LOG_OR) LOG_NOT? ID (LESSER | LESSER_EQUAL | GREATER | GREATER_EQUAL | EQUAL | NONEQUAL) (ID | ANY_LITERAL))* 
...
loop_scope: ((for_loop | while_loop | switch_case | BREAK SEMICOLON | CONTINUE SEMICOLON | if_statement | variable SEMICOLON))*
