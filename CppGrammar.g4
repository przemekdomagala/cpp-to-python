...
struct_body: ((PRIVATE | PUBLIC | PROTECTED) COLON)? (variable_declaration | function) (((PRIVATE | PUBLIC | PROTECTED) COLON)? (variable_declaration | function))*;
...
function_scope: (for_loop | while_loop | arithmetic_operation SEMICOLON | if_statement | function_call | variable_declaration | assign | enum_namespace_call ID)* (RETURN (enum_namespace_call? ID | (INT_LITERAL | CHAR_LITERAL | DOUBLE_LITERAL | FLOAT_LITERAL | BOOL_LITERAL))? SEMICOLON)?;
