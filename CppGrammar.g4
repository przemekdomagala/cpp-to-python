...
assign: ID ASSIGN (ID | ANY_LITERAL)
function: STATIC? CONST? (VOID | class_name | UNSIGNED? CHAR | UNSIGNED? SHORT | UNSIGNED? LONG | UNSIGNED? INT_TYPE | FLOAT | DOUBLE | BOOL) ID LEFT_PARENTHESIS (variable (COMMA variable)*)? RIGHT_PARENTHESIS LEFT_BRACKET function_scope RIGHT_BRACKET SEMICOLON 
function_scope: for_loop* while_loop* if_statement* 
for_loop: FOR LEFT_PARENTHESIS variable SEMICOLON if_expression
...
loop_scope: ((for_loop | while_loop | BREAK SEMICOLON | CONTINUE SEMICOLON | if_statement | variable | assign SEMICOLON))*
